...
<main>
    ...
    <div class="col-12  bg-light text-dark p-4 mb-4">
        ...
        <div class="inputBox">
            <form  action="create.reg" name="Register" method="post" onsubmit="return RegisterCheck()">
                <p>Username</p>
                <input class="input" type="text" name="userName" value="${param.userName}" required><br>
                <p>E-mail</p>
                <input class="input" type="email" name="email" value="${param.email}" required><br>
                <p>Password</p>
                <input class="input" type="password" name="password" oninput="passStrength()" required><span id="passStrength"></span><br>
                <p>Confirm Your Password</p>
                <input class="input" type="password" name="passwordConfirm" required><br>
                <p>Code</p>
                <div class="code">
                ...
                <p class="warning">The userName or email has been used!</p>
                <%}%>
