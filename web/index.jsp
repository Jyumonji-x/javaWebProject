...
<%
  List<TravelImage> newImages = (List<TravelImage>) request.getAttribute("newImages");
  List<TravelImage> popImages = (List<TravelImage>) request.getAttribute("popImages");
%>
<html>
<head>
  <meta charset="UTF-8">
...
<main>
  ...
  <div id="hot" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <a href="show.detail?imageId=<%=popImages.get(0).getImageID()%>">
          <img class="d-block w-100" src="./img/images/<%=popImages.get(0).getPath()%>">
        </a>
      </div>
      <div class="carousel-item">
        <a href="show.detail?imageId=<%=popImages.get(1).getImageID()%>">
          <img class="d-block w-100" src="./img/images/<%=popImages.get(1).getPath()%>">
        </a>
      </div>
      <div class="carousel-item">
        <a href="show.detail?imageId=<%=popImages.get(2).getImageID()%>">
          <img class="d-block w-100" src="./img/images/<%=popImages.get(2).getPath()%>">
        </a>
      </div>
      <div class="carousel-item">
        <a href="show.detail?imageId=<%=popImages.get(3).getImageID()%>">
          <img  class="d-block w-100" src="./img/images/<%=popImages.get(3).getPath()%>">
        </a>
      </div>
    </div>
    <!-- 左右切换按钮 -->
    <a class="carousel-control-prev" href="#hot" data-slide="prev">
      <span class="carousel-control-prev-icon"></span>
    </a>
    <a class="carousel-control-next" href="#hot" data-slide="next">
  ...
  <div class="card mb-3 col-12">
    <div class="row no-gutters">
      <div class="pictureFrame col-2">
        <a href="show.detail?imageId=<%=newImages.get(0).getImageID()%>">
          <div class="pictureShowingPicture card-img" style="background-image: url('./img/images/<%=newImages.get(0).getPath()%>');">
          </div>
        </a>
      </div>
      <div class="col-8">
        <div class="card-body">
          <h5 class="card-title">
            <%=newImages.get(0).getTitle()%>
          </h5>
          <p class="card-text shortContent">
            <%=new UserDaoImpl().getByUid(newImages.get(0).getUid()).getUserName()%>
          </p>
            <p class="card-text shortContent">
                <%=newImages.get(0).getContent()%>
            </p>
          <p class="card-text shortContent">
            <%=newImages.get(0).getLastModifiedTime()%>
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="card mb-3 col-12">
    <div class="row no-gutters">
      <div class="pictureFrame col-2">
        <a href="show.detail?imageId=<%=newImages.get(1).getImageID()%>">
          <div class="pictureShowingPicture card-img" style="background-image: url('./img/images/<%=newImages.get(1).getPath()%>');">
          </div>
        </a>
      </div>
      <div class="col-8">
        <div class="card-body">
          <h5 class="card-title">
            <%=newImages.get(1).getTitle()%>
          </h5>
          <p class="card-text shortContent">
            <%=new UserDaoImpl().getByUid(newImages.get(1).getUid()).getUserName()%>
          </p>
            <p class="card-text shortContent">
                <%=newImages.get(1).getContent()%>
            </p>
          <p class="card-text shortContent">
            <%=newImages.get(1).getLastModifiedTime()%>
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="card mb-3 col-12">
    <div class="row no-gutters">
      <div class="pictureFrame col-2">
        <a href="show.detail?imageId=<%=newImages.get(2).getImageID()%>">
          <div class="pictureShowingPicture card-img" style="background-image: url('./img/images/<%=newImages.get(2).getPath()%>');">
          </div>
        </a>
      </div>
      <div class="col-8">
        <div class="card-body">
          <h5 class="card-title">
            <%=newImages.get(2).getTitle()%>
          </h5>
          <p class="card-text shortContent">
            <%=new UserDaoImpl().getByUid(newImages.get(2).getUid()).getUserName()%>
          </p>
            <p class="card-text shortContent">
                <%=newImages.get(2).getContent()%>
            </p>
          <p class="card-text shortContent">
            <%=newImages.get(2).getLastModifiedTime()%>
          </p>
        </div>
      </div>
    </div>
  ...
  <div class="card mb-3 col-12">
    <div class="row no-gutters">
      <div class="pictureFrame col-2">
        <a href="show.detail?imageId=<%=newImages.get(3).getImageID()%>">
          <div class="pictureShowingPicture card-img" style="background-image: url('./img/images/<%=newImages.get(3).getPath()%>');">
          </div>
        </a>
      </div>
      <div class="col-8">
        <div class="card-body">
          <h5 class="card-title">
            <%=newImages.get(3).getTitle()%>
          </h5>
          <p class="card-text shortContent">
            <%=new UserDaoImpl().getByUid(newImages.get(3).getUid()).getUserName()%>
          </p>
            <p class="card-text shortContent">
                <%=newImages.get(3).getContent()%>
            </p>
          <p class="card-text shortContent">
            <%=newImages.get(3).getLastModifiedTime()%>
          </p>
        </div>
      </div>
    </div>
